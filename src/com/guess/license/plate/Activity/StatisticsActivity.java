...
public class StatisticsActivity extends SherlockActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Title.SetTitle(Component.STATS, actionBar, this.getBaseContext());
		Language.SetLanguage(Component.STATS, this.getBaseContext());
		Theme.SetTheme(Component.STATS, this.getBaseContext());
	}
	...
	public void onResume(){
		...
		Utility.SetTransition(this.getBaseContext(), this, Component.STATS);
