 ...
 * 
 * This class handle the Best Score activity
 *
 */
public class BestScoreActivity extends SherlockActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		try {
			...
			Title.SetTitle(Component.BEST_SCORE, actionBar, this.getBaseContext());
			Language.SetLanguage(Component.BEST_SCORE, this.getBaseContext());
			Theme.SetTheme(Component.BEST_SCORE, this.getBaseContext());
			
		} catch (Exception e) {
			Log.e(Logs.BEST_SCORE, e.getMessage());
		}
	}
	...
	public void onResume(){
		...
		Utility.SetTransition(this.getBaseContext(), this, Component.BEST_SCORE);
	}
