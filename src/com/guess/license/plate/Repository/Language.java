...
import com.guess.license.plate.Activity.MainStatisticsActivity;
...
public class Language {
	...
	public static void SetLanguage(Component language, Context context) {
		switch (language) {
		case SPLASH:
	...
	private static void SetSplashLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			...
			String[] strArr = GetStringArray(Component.SPLASH, context, language, SIZE);
			if(strArr != null)
			{
	...
	private static void SetMainLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.MAIN, context, language, SIZE);
			if(strArr != null)
			{
	...
	private static void SetStartLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.START, context, language, SIZE);
			if(strArr != null)
			{
	...
	private static void SetBestScoreLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.BEST_SCORE, context, language, SIZE);
			if(strArr != null)
			{
	...
	public static void SetSettingLanguage(Context context, SherlockPreferenceActivity preference) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {			
			...
			String[] strTitle = GetStringArray(Component.SETTING_TITLE, context, language, SIZE);
			// Getting all the summaries for the language selected
			String[] strSummary = GetStringArray(Component.SETTING_SUMMARY, context, language, SIZE);
	...
	public static void SetTitleAndSummary(SherlockPreferenceActivity preference, String[] strTitle, String[] strSummary, Preferences type, Context context, String language){
		...
		switch(type)
		{
			...
			case CLEAR:
				...
				String[] strClear = GetStringArray(Component.SETTING_CLEAR_MESSAGE, context, language, SIZE);				
				if(strClear != null){	
	...
	private static void SetScoreLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.SCORE, context, language, SIZE);
			if(strArr != null)
			{
	...
	private static void SetStatsLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.STATS, context, language, SIZE);
			if(strArr != null)
			{
	...
	private static void SetStatsListLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.STATS_LIST, context, language, SIZE);
			if(strArr != null)
			{
	...
	public static void SetAboutLanguage(Context context){
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.ABOUT, context, language, SIZE);
			if(strArr != null){
	...
	public static String GetServerErrorLanguage(ServerError serverError, Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			String[] strArr = GetStringArray(Component.SPLASH_ERROR_MESSAGE, context, language, SIZE);
			if(strArr != null)
			{
				switch(serverError){
					case NO_ERROR:
	...
	public static String[] GetSplashAlertLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			result = GetStringArray(Component.SPLASH_ALERT_MESSAGE, context, language, SIZE);
		}
	...
	public static String[] SetMainListLanguage(Context context) {
		...
		if (prefs.length == SharedPreference.STRING_SIZE) {
			String language = prefs[0];
			strArr = GetStringArray(Component.MAIN_LIST, context, language, SIZE);
		}
		return strArr;
	}
	
	// This method returns an array with all the string for the activity and language selected
	public static String[] GetStringArray(Component activity, Context context, String language, int size){
		String arrName = null;
