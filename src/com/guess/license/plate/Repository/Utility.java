...
public class Utility {
	...
	public static String[] FillDefaultVals(Component activity, String[] info, String defaultVal1, String defaultVal2){
	...
	// Set the transition
	public static void SetTransition(Context context, SherlockActivity act, Component actDest){
	...
	// Set the transaction
	public static void SetTransition(Context context, SherlockPreferenceActivity act, Component actDest){
		SetAudio(context, SharedPreference.GetSharedPreferenceBool(context)[1], 0);
		Intent intent = act.getIntent();
		if(intent != null){
			if(intent.getExtras() != null)
