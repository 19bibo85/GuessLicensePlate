...
public class ScoreAsyncTask extends AsyncTask<DatabaseHelper, Void, Object>{
	private MainActivity mainActivity = null;
	private GameActivity gameActivity = null;
	private OptionDialogPreference dialogPreference = null;
	private SQLiteDatabase db;
	
	public ScoreAsyncTask(MainActivity mainActivity){
		this.mainActivity = mainActivity;
	}
	
	public ScoreAsyncTask(GameActivity gameActivity){
		this.gameActivity = gameActivity;
	}
	
	public ScoreAsyncTask(OptionDialogPreference dialogPreference){
	...
	private ArrayList<String> queryBestScores(DatabaseHelper databaseHelper){
		...
		arrayObj = Utility.FillDefaultVals(Component.BEST_SCORE, arrayObj, SCORE_DEFAULT, RATE_DEFAULT);
