...
import com.guess.license.plate.Repository.OptionDialogPreference;
...
public class StatisticsAsyncTask extends AsyncTask<DatabaseHelper, Void, Object>{
	...
	private long addRow(Context context, DatabaseHelper databaseHelper, String imgID, int answer){
	...
	private ArrayList<String> queryMainStatistic(Context context, DatabaseHelper databaseHelper, int modeID){
		...
		info = Utility.FillDefaultVals(Component.STATS, info, Integer.toString(DEFAULT_NUMERIC), defaultString);
