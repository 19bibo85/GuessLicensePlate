...
public class Title {
	...
	public static void SetTitle(com.guess.license.plate.Activity activity, com.actionbarsherlock.app.ActionBar actionBar, Context context)
	{
		switch (activity) {
		case MAIN:
...
//	private static void SetMainTitle(View view, Context context){
//		String[] prefs = SharedPreference.GetSharedPreference(context);
//		
//		if (prefs.length == SharedPreference.SIZE) {
...
//						parentView.setBackgroundResource(R.drawable.title_background_blue);	
//					} else if(theme.equals("Theme 2")){
//						parentView.setBackgroundResource(R.drawable.title_background_black);
//					} else if(theme.equals("Theme 3")){
//						parentView.setBackgroundResource(R.drawable.title_background_grey);
//					} else if(theme.equals("Theme 4")){
//						parentView.setBackgroundResource(R.drawable.title_background_orange);					
//					} else if(theme.equals("Theme 5")){
//						parentView.setBackgroundResource(R.drawable.title_background_purple);
//					}					
//				}
//			}
//		}
